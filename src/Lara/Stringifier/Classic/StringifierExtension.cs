...
{
    /// <summary>
    /// Helps the developer during debuging by providing an easy way of stringify the properties of an object instance.
    /// </summary>
    public static class StringifierExtension
    {
        /// <summary>
